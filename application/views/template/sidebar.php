                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="navbar">
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    <?php
                                    $keranjang = 'Keranjang Benlanja: ' . $this->cart->total_items() . ' items'
                                        ?>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <?php if ($this->session->userdata('username')) { ?>
                                    ...
                                    <li class="ml-2"><a href="<?= base_url('auth/logout'); ?>">Logout</a></li>
                                <?php } else { ?>
                                    <li class="ml-2"><a href="<?= base_url('auth/login'); ?>">Login</a></li>
                                <?php }
                                ; ?>
                            </ul>
                        </div>
